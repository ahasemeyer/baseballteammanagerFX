...
public class CreatePlayerPageController implements Initializable {
    ...
    {  
        ...
        Player newPlayer = Data.DBUtil.createPlayer(firstName.getText(), lastName.getText(), inPos, inNumber, inArm, inStance, sqlTeamID);
        ...
        if(hitterRadio.isSelected())
        {
            ...
            Data.DBUtil.createHitter(newPlayer.getPlayerid());
        }
        if(pitcherRadio.isSelected())
        {
            ...
            Data.DBUtil.createPitcher(newPlayer.getPlayerid());
        }
        if(managerRadio.isSelected())
        {
            ...
            Data.DBUtil.createManager(newPlayer.getPlayerid());
        }     
